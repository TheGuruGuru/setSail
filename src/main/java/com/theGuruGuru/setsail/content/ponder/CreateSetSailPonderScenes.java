...
public class CreateSetSailPonderScenes {

    /**
     * Storyboard for the setsail_ponder.nbt schematic: a 5x5 andesite base plate (layer 0)
    ...
    public static void examplePonder(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        // (ponder.setsail.setsail_ponder.*), so keep it matching the storyboard id.
        scene.title("setsail_ponder", "Welcome to the Example Addon");
        ...
        // schematic-local, matching the coordinates baked into setsail_ponder.nbt.
        ...
        scene.overlay().showText(70)
                .text("Every block here is loaded from setsail_ponder.nbt")
                .independent(10);
        scene.idle(80);
