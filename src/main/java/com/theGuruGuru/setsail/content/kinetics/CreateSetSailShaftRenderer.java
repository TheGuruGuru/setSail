 ...
 */
public class CreateSetSailShaftRenderer<T extends KineticBlockEntity> extends KineticBlockEntityRenderer<T> {

    public CreateSetSailShaftRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
