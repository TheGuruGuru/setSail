 ...
 */
public class CreateSetSailSequencedAssemblyGen extends SequencedAssemblyRecipeGen {

    GeneratedRecipe EXAMPLE = create("setsail_result", b -> b
    ...
    public CreateSetSailSequencedAssemblyGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
